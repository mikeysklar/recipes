...
- [`pr/pr-general-scanner/pr-general-scanner.md`](pr/pr-general-scanner/pr-general-scanner.md) —
  ...
  them.
- [`pr-circuitpython/circuitpython-review.md`](pr-circuitpython/circuitpython-review.md) —
...
- [`pr-wippersnapper/wippersnapper-pr.md`](pr-wippersnapper/wippersnapper-pr.md) —
  the same, for `adafruit/Adafruit_Wippersnapper_Arduino` (brentru and tyeth).
  Bundled with the maintainers' own
  [`add-sensor-component-v1.SKILL.md`](pr-wippersnapper/add-sensor-component-v1.SKILL.md),
